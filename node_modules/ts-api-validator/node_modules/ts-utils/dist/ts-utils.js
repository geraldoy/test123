...
(function () {define("src/Receiver", ["require", "exports", "src/Signal"], function (require, exports, Signal_1) {
    "use strict";
    exports.__esModule = true;
...
(function () {define("src/tree/BaseTree", ["require", "exports", "src/utils"], function (require, exports, utils_4) {
    "use strict";
    exports.__esModule = true;
    var BaseTree = /** @class */ (function () {
        function BaseTree(data, parent, options) {
            ...
            this.parent = parent;
            this.id = data.id;
            this.data = utils_4.cloneDeep(data.data);
...
(function () {define("src/tree/Tree", ["require", "exports", "src/tree/BaseTree", "src/filters"], function (require, exports, BaseTree_1, filters_2) {
    "use strict";
    exports.__esModule = true;
    var Tree = /** @class */ (function (_super) {
        ...
        Tree.prototype.where = function (data) {
            var _this = this;
            var filter = typeof data === 'object' ? filters_2.containsDeep(data) : filters_2.contains(data);
...
(function () {define("index", ["require", "exports", "src/utils", "src/filters", "src/Signal", "src/utilsWithFilters", "src/Path", "src/Iterator", "src/Receiver", "src/tree/BaseTree", "src/tree/Tree"], function (require, exports, utils_5, filters_3, Signal_2, utilsWithFilters_1, Path_2, Iterator_2, Receiver_1, BaseTree_2, Tree_1) {
    "use strict";
    function __export(m) {
